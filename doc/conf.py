...
# }
html_theme = "classic"
html_theme_options = {"stickysidebar": True, "body_max_width": "110em"}
...
latex_documents = [
    (master_doc, "mass.tex", "mass Documentation", "Joe Fowler, Galen O'Neil, Young Il Joe, Dan Becker", "manual"),
]
...
man_pages = [(master_doc, "mass", "mass Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "mass", "mass Documentation", author, "mass", "One line description of project.", "Miscellaneous"),
]
