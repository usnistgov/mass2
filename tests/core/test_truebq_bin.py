...
def test_basic():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        ch_mem = trigger_result.to_channel_copy_to_memory(
            noise_n_dead_samples_after_pulse_trigger=100, npre=100, npost=100, invert=False
        )
        ...
        # do explicit cleanup to avoid a windows file locking error
        # https://chatgpt.com/share/68a485a2-c258-8002-9ba6-fa4ec7edb78e
        del ch_mem
        del ch_mmap
        del trigger_result
        del read_truebq_bin
