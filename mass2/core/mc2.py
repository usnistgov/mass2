...
def main() -> None:
    ...
    parser.add_argument(
        "-d", "--dry-run", action="store_true", help="don't perform analysis, just say what would be done (default: False)"
    )
...
def encode_counter(j: int, nchar: int = 4) -> str:
    ...
    (Crockford's base-32 encoding: https://www.crockford.com/base32.html). Use this
    for labeling Parquet files. 4 characters encodes 20 bits, or over 1 million values."""
    c = []
